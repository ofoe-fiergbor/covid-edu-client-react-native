...
const dataArray = [
  {
    title: "How are COVID-19 patients treated?",
    content:
  ...
  {
    title:
      "Who is at risk for infection with SARS-COV-2, the virus that causes COVID-19?",
    content:
  ...
  {
    title: "Who is at risk for severe COVID-19?",
    content:
  ...
  {
    title:
      "Can people who recover from COVID-19 be re-infected with SARS-CoV2?",
    content:
  ...
  {
    title: "What antiviral drugs are available to treat COVID-19?",
    content:
      "There are currently no antiviral drugs approved by FDA to treat COVID-19.",
  },
  {
    title:
      "Are any changes recommended to asthma treatment plan if my patient with asthma has COVID-19?",
    content:
